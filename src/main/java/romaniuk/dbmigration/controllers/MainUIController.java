...
import romaniuk.dbmigration.tool.*;
...
public class MainUIController implements Initializable {
    ...
    private void setOnMouseClickedBtnDownloadToXMLMigrTab() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("/ui/DownloadToXML.fxml"));
        } catch (IOException e) {
    ...
    private void setOnMouseClickedBtnMigrToolMigrTab() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("/ui/MigrationTool.fxml"));
        } catch (IOException e) {
            logger.log(Level.SEVERE, e.getMessage());
        }
        window.setScene(new Scene(root, 500, 200));
    ...
    private void setOnMouseClickedBtnReplicationOfTablesMigrTab() {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("/ui/ReplicationOfTables.fxml"));
        } catch (IOException e) {
            logger.log(Level.SEVERE, e.getMessage());
        }
        window.setScene(new Scene(root, 500, 200));
    ...
    private void setOnMouseClickedBtnCreateDBMigrTab() {
        try {
            Stage window = new Stage();
            Parent root = null;
            root = FXMLLoader.load(getClass().getResource("/ui/CreateNewDB.fxml"));
            window.setScene(new Scene(root, 500, 200));
