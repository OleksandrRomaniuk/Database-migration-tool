package romaniuk.popupwindows;

import javafx.fxml.FXMLLoader;
import javafx.scene.Parent;
import javafx.scene.Scene;
import javafx.stage.Stage;
import romaniuk.controllers.PasswordWindowController;
...
public class PasswordWindow {
    ...
    private void getWindow() {
        ...
        try {
            st = new Stage();
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/romaniuk/ui/PasswordWindow.fxml"));
